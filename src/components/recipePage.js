                        ...
                        recipes.map(recipe =>(
                            <div className="col-12 col-md-4 mb-5" key={recipe._id}>
                                ...
                                <div className="card shadow p-2">
                                    <img src={recipe.src} alt="store-avatar" className="card-img-top img-fluid cover-fill" />
                                <div className="card-body">
                                    
                                <h3 className="heading font-weight-bold mb-3 text-center text-uppercase">{recipe.title}</h3>
