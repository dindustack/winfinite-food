                ...
                <div className="container">
                    ...
                    <div className="row justify-content-between">
                        ...
                        <div className="col-12 col-md-6 mb-5">
                            ...
                            <p className="small text-muted font-weight-bold">29 Mambilla street  off Aso Drive Abuja, Nigeria</p>
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-md-6 mb-5">
                            ...
                            <a className="text-decoration-none text-muted" href="tel:+234-813-680-8501">+2348136808501</a>
                            </h6>
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-md-6 mb-5">
                            ...
                            <h6 className="small font-weight-bold">                                
                            <a className="text-decoration-none text-muted" href="mailto:info@winfinitefoods.com">info@winfinitefoods.com</a>
                            </h6>
                            </div>
                            </div>
                        </div>
