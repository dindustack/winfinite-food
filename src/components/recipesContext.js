...
export class InfoProvider extends Component {
  state = {
    recipes: [
      ...
      //vegetable nuts and seeds butter soup
      {
        ...
        introtext:
          "This vegetable nuts and seeds butter soup is hearty, nutritious and lightly spicy; nuts n Seeds butter and sweet potato are a match made in vegan heaven.",
        ingredients: [
      ...
      //creamy-nuts-and-seed-butter-beans-curry
      {
        ...
        introtext:
          "Looking for a delicious vegan recipe? You've come to the right place. This one is an absolute banger. This creamy nuts n seeds butter beans curry will get rid of any midweek blues.",
        ingredients: [
          "2 tablespoons  of oil",
  ...
  render() {
    ...
    return <InfoContext.Provider value={{ recipes }}>{this.props.children}</InfoContext.Provider>;
  }
}
