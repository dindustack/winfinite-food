                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-4 mb-5">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <div className="pl-3">
                                    ...
                                    <span className="small text-muted font-weight-bold">29 Mambilla street  off Aso Drive Abuja</span>
                                </div>
                                </li>
                            </ul>
                        ...
                        <div className="col-12 col-md-4 mb-5">
                            ...
                            <h5 className="font-weight-bold mb-3">HMEDIX Pharmacy and Supermarket nationwide</h5>
