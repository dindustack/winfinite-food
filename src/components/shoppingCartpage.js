                        ...
                        <div className="col-12 col-md-7">
                            ...
                            <li className="list-group-item" key={item._id}>
                                ...
                                <div className="col mt-md-3 mb-3 mb-md-3">
                                    ...
                                    <Link to="/:id" className="heading text-decoration-none h5 text-blue text-uppercase font-weight-bold">{item.title}</Link> <span className="ml-auto text-orange font-weight-bold">&#8358;{item.price * item.count}</span>
                                    </div>
                                    ...
                                    {/* -- Remove -- */}
                                    <a className="small text-muted text-decoration-none ml-auto" href="#action" onClick={() => removeProduct(item._id)}>
                        ...
                        <div className="col-12 col-md-5 col-lg-4 offset-lg-1">
                            ...
                            <div className="card-body p-0">
                                ...
                                <li className="list-group-item d-flex">
                                    <span>Subtotal</span> <span className="ml-auto small">&#8358;{subtotal}</span>
                                </li>
                                <li className="list-group-item d-flex">
                                    <span>Delivery</span> <span className="ml-auto small">&#8358;0</span>
                                </li>
                                <li className="list-group-item d-flex large font-weight-bold">
                                    <span>Total</span> <span className="ml-auto font-size-sm">&#8358;{total + subtotal}</span>
                                </li>
                            ...
                            {/* -- Button -- */}
                            <Link to="/checkout" className="btn btn-block btn-dark mb-2">Proceed to Checkout</Link>
