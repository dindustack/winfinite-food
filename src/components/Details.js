                        ...
                        <div className="container">
                                <div className="row">
                                    ...
                                    <div className="row">
                                        ...
                                        {/* - Heading -- */}
                                        <h3 className="heading display-4 font-weight-bold mt-md-3 mb-2">{item.heading}<span className="display-none ml-2 h6">({item.weight})</span></h3>
                                        
                                        {/* -- Price -- */}
                                        <div className="mb-5">
                                        <span className="ml-1 h5 font-weight-bolder text-orange">&#8358;{item.price}</span>
                                        </div>
                                        ...
                                        <button type="submit" className="btn btn-block btn-success mb-2">
                                           Proceed to Checkout <svg viewBox="0 0 20 20" fill="#fff" width="16px" className="ml-2">
                                                        ...
                                                        <div className="row justify-content-center py-5">
                                                            <div className="col-12 col-lg-12 col-xl-12">
                                                                ...
                                                                <div className="col-12">
                                                                    ...
                                                                    {/* <!-- Text --> */}
                                                                    <p className="text-muted">{item.content.description.make}</p>

                                                                    <hr />
                                                                    <p className="text-muted">{item.content.description.use}</p>

                                                                    <hr />
                                                                    <p className="text-muted">
                                                                    Store in a cool dry place. Oil separation occurs naturally. 
                                                                    Upside down jar for easy stirring. Stir well with a butter 
                                                                    knife and store lid-side up. Once opened, eat within three months (easy!).
                                                                    </p>
                                                        ...
                                                        <div className="row justify-content-center py-5">
                                                            <div className="col-12 col-lg-12 col-xl-12">
                                                                ...
                                                                <div className="col-12">
                                                                    ...
                                                                    <p className="text-muted">{item.content.ingredients.condiments}</p>
                                                                                                                             

                                                                    <hr />
                                                                    <p className="text-muted">
                                                                        Vegan friendly, no sugar added, kosher, plant-based protein, high in fibre. 
                                                                        Keto, natural ingredients, gluten free, non gmo, dairy free
                                                                    </p>
